    ...
    createStructure = function(items) {
      ...
      items.forEach(function(item, i) {
        ...
        if (!Number.isInteger(item)) {
          ...
          // if the section is already declared without a title
          ...
          // if the string is not a link then the string is paragraph
        ...
        // for numbers
          ...
          // then declare new section
          if (items[i + 1] && !Number.isInteger(items[i + 1])) {

            // before the declaration of a new section
            // set default styles for the previous section
          ...
          // if the previous and the next items are numbers
